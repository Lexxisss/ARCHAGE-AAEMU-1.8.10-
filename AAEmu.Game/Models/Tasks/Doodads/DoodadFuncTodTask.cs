...
public class DoodadFuncTodTask : DoodadFuncTask
{
    ...
    public override void Execute()
    {
        ...
        // Same field, same race as everywhere else it is cancelled: take it atomically rather
        // than test it and then dereference it a line later.
        _owner.CancelFuncTask(_caster);
