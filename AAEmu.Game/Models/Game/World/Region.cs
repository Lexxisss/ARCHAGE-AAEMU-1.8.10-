...
public class Region
{
    ...
    public void AddToCharacters(GameObject obj)
    {
        ...
        if (obj is Character objectAsCharacter)
        {
            ...
            // During 10.8 login the streamed map doodads arrive first. The
            // full server-side DoodadInfo records are published only after
            // CSWorldEntryReady, preventing create records from racing the
            // TCDoodadStream cell data. Region changes after login still use
