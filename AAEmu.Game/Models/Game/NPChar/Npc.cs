...
public class Npc : Unit
{
    ...
    public float RoamRadius { get; set; } = 300f; // 3m
    ...
    public List<float> PatrollingPoints { get; set; }
    ...
    public override void AddVisibleObject(Character character)
    {
        ...
        if (visibleNpcIds?.Contains(ObjId) != true)
        {
    ...
    {
        character?.Connection?.Protocol1810VisibleNpcObjIds.Remove(ObjId);
