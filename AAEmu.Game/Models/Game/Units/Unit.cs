...
public class Unit : BaseUnit, IUnit
{
    ...
    public virtual void PopulateFormulaParameters(System.Collections.Generic.Dictionary<string, double> parameters, bool skipCoreStats = false)
    {
...
#pragma warning restore CA1822 // Mark members as static
    ...
    */
    ...
    public static void ModelPosture(PacketStream stream, Unit unit, BaseUnitType baseUnitType,
        ModelPostureType modelPostureType, uint animActionId = 0xFFFFFFFF, bool activateAnimation = true)
    {
        // The packet constructor already selected the posture represented by
        // SCUnitState. Do not silently replace ActorModelState for attackable
        // NPCs, otherwise the two packets describe different layouts.
        stream.Write((byte)modelPostureType);
        stream.Write(false); // isLooted; loot-state mapping is not confirmed yet
