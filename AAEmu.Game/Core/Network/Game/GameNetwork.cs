...
public class GameNetwork : Singleton<GameNetwork>
{
    ...
    private GameNetwork()
    {
        ...
        RegisterPacket(CSOffsets.CSProtocol1810MoveUnitPacket, 5, typeof(CSProtocol1810MoveUnitPacket));
        ...
        RegisterPacket(CSOffsets.CSPostSelectCharacterPacket, 5, typeof(CSPostSelectCharacterPacket));
        ...
        RegisterPacket(CSOffsets.CSWorldEntryReadyPacket, 5, typeof(CSWorldEntryReadyPacket));
        RegisterPacket(CSOffsets.CSPostLoadStatePacket, 5, typeof(CSPostLoadStatePacket));
        RegisterPacket(CSOffsets.CSLobbyStateTransitionPacket, 5, typeof(CSLobbyStateTransitionPacket));
        RegisterPacket(CSOffsets.CSStartupNotificationPacket, 5, typeof(CSStartupNotificationPacket));
        ...
        RegisterPacket(CSOffsets.CSTargetCharacterConnectionRestrictPacket, 5, typeof(CSTargetCharacterConnectionRestrictPacket));
        ...
        RegisterPacket(CSOffsets.CSPostLoadObjectStatePacket, 5, typeof(CSPostLoadObjectStatePacket));
