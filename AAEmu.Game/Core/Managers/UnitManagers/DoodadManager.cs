...
public class DoodadManager : Singleton<DoodadManager>
{
    ...
    public void Load()
    {
        ...
        using (var connection = DoodadSQLite.CreateConnection())
        {
            #region doodad_funcs
                ...
                using (var reader = new SQLiteWrapperReader(sqliteDataReader))
                {
                    while (reader.Read())
                    {
                        var func = new DoodadFunc
                        {
                            ...
                            PermId = reader.GetUInt32("perm_id", 0),
                            Count = reader.GetInt32("act_count", 0),
                            PopupWarn = reader.GetBoolean("popup_warn", false),
                            ForbidOnClimb = reader.GetBoolean("forbid_on_climb", false),
                            PopupDesc = reader.GetString("popup_desc", string.Empty),
                            ResetFirstInteraction = reader.GetBoolean("reset_first_interaction", false)
                        };
            ...
            if (DoodadSQLite.TableExists(connection, "doodad_func_butchers"))
            {
            using (var command = connection.CreateCommand())
            {
            ...
            // doodad_func_catches
            if (DoodadSQLite.TableExists(connection, "doodad_func_catches"))
            {
            using (var command = connection.CreateCommand())
            {
            ...
            if (DoodadSQLite.TableExists(connection, "doodad_func_cereal_harvests"))
            {
            using (var command = connection.CreateCommand())
            {
                ...
                using (var reader = new SQLiteWrapperReader(command.ExecuteReader()))
                {
                    while (reader.Read())
                    {
                        var func = new DoodadFuncClimb
                        {
                            ...
                            // Removed from the 10.8 schema.
                            AllowHorizontalMultiHanger = false
                        };
            ...
            // doodad_func_consume_changer_items (10.8)
            using (var command = connection.CreateCommand())
            {
            ...
            // doodad_func_consume_changer_model_items (10.8)
            using (var command = connection.CreateCommand())
            {
                ...
                using (var reader = new SQLiteWrapperReader(command.ExecuteReader()))
                {
                    while (reader.Read())
                    {
                        ...
                        {
                            Id = reader.GetUInt32("id"),
                            DoodadFuncConsumeChangerModelId = reader.GetUInt32("doodad_func_consume_changer_model_id", 0),
                            ItemId = reader.GetUInt32("item_id", 0),
            ...
            if (DoodadSQLite.TableExists(connection, "doodad_func_consume_items"))
            {
            using (var command = connection.CreateCommand())
            {
            ...
            if (DoodadSQLite.TableExists(connection, "doodad_func_crop_harvests"))
            {
            using (var command = connection.CreateCommand())
            {
            ...
            if (DoodadSQLite.TableExists(connection, "doodad_func_crystal_collects"))
            {
            using (var command = connection.CreateCommand())
            {
            ...
            if (DoodadSQLite.TableExists(connection, "doodad_func_cutdowns"))
            {
            using (var command = connection.CreateCommand())
            {
            ...
            if (DoodadSQLite.TableExists(connection, "doodad_func_dairy_collects"))
            {
            using (var command = connection.CreateCommand())
            {
            ...
            // doodad_func_digs
            if (DoodadSQLite.TableExists(connection, "doodad_func_digs"))
            {
            using (var command = connection.CreateCommand())
            {
            ...
            if (DoodadSQLite.TableExists(connection, "doodad_func_dyeingredient_collects"))
            {
            using (var command = connection.CreateCommand())
            {
            ...
            // doodad_func_feeds
            if (DoodadSQLite.TableExists(connection, "doodad_func_feeds"))
            {
            using (var command = connection.CreateCommand())
            {
            ...
            if (DoodadSQLite.TableExists(connection, "doodad_func_fiber_collects"))
            {
            using (var command = connection.CreateCommand())
            {
            ...
            if (DoodadSQLite.TableExists(connection, "doodad_func_fruit_picks"))
            {
            using (var command = connection.CreateCommand())
            {
            ...
            if (DoodadSQLite.TableExists(connection, "doodad_func_gass_extracts"))
            {
            using (var command = connection.CreateCommand())
            {
            ...
            if (DoodadSQLite.TableExists(connection, "doodad_func_harvests"))
            {
            using (var command = connection.CreateCommand())
            {
            ...
            if (DoodadSQLite.TableExists(connection, "doodad_func_housing_areas"))
            {
            using (var command = connection.CreateCommand())
            {
            ...
            // doodad_func_hungers
            if (DoodadSQLite.TableExists(connection, "doodad_func_hungers"))
            {
            using (var command = connection.CreateCommand())
            {
            ...
            if (DoodadSQLite.TableExists(connection, "doodad_func_machine_parts_collects"))
            {
            using (var command = connection.CreateCommand())
            {
            ...
            if (DoodadSQLite.TableExists(connection, "doodad_func_medicalingredient_mines"))
            {
            using (var command = connection.CreateCommand())
            {
            ...
            // doodad_func_mows
            if (DoodadSQLite.TableExists(connection, "doodad_func_mows"))
            {
            using (var command = connection.CreateCommand())
            {
            ...
            if (DoodadSQLite.TableExists(connection, "doodad_func_navi_open_bounties"))
            {
            using (var command = connection.CreateCommand())
            {
            ...
            if (DoodadSQLite.TableExists(connection, "doodad_func_ore_mines"))
            {
            using (var command = connection.CreateCommand())
            {
            ...
            if (DoodadSQLite.TableExists(connection, "doodad_func_plant_collects"))
            {
            using (var command = connection.CreateCommand())
            {
            ...
            if (DoodadSQLite.TableExists(connection, "doodad_func_renew_items"))
            {
            using (var command = connection.CreateCommand())
            {
            ...
            if (DoodadSQLite.TableExists(connection, "doodad_func_rock_mines"))
            {
            using (var command = connection.CreateCommand())
            {
            ...
            if (DoodadSQLite.TableExists(connection, "doodad_func_seed_collects"))
            {
            using (var command = connection.CreateCommand())
            {
            ...
            // doodad_func_shears
            if (DoodadSQLite.TableExists(connection, "doodad_func_shears"))
            {
            using (var command = connection.CreateCommand())
            {
            ...
            if (DoodadSQLite.TableExists(connection, "doodad_func_skin_offs"))
            {
            using (var command = connection.CreateCommand())
            {
            ...
            if (DoodadSQLite.TableExists(connection, "doodad_func_soil_collects"))
            {
            using (var command = connection.CreateCommand())
            {
            ...
            if (DoodadSQLite.TableExists(connection, "doodad_func_spice_collects"))
            {
            using (var command = connection.CreateCommand())
            {
            ...
            if (DoodadSQLite.TableExists(connection, "doodad_func_tree_byproducts_collects"))
            {
            using (var command = connection.CreateCommand())
            {
            ...
            // Target 10.8 private coffers are normal selectable doodad funcs.
            if (DoodadSQLite.TableExists(connection, "doodad_func_private_coffers"))
            {
                using var command = connection.CreateCommand();
                ...
                while (reader.Read())
                {
                    ...
                    {
                        Id = reader.GetUInt32("id"),
                        Capacity = reader.GetInt32("capacity", 10),
                        IsManikin = reader.GetBoolean("is_manikin", false)
                    };
                    _funcTemplates["DoodadFuncPrivateCoffer"].Add(func.Id, func);
                }
            }

            InstallTargetFunctionFallbacks();
                ...
                using (var reader = new SQLiteWrapperReader(sqliteDataReaderChild))
                {
                    while (reader.Read())
                    {
                        var funcGroups = new DoodadFuncGroups
                        {
                            ...
                            Model = reader.GetString("model", string.Empty),
                            PhaseMessage = reader.GetString("phase_msg", string.Empty),
                            Name = reader.GetString("name", string.Empty),
                            SoundTime = reader.GetUInt32("sound_time", 0),
                            IsMessageToZone = reader.GetBoolean("is_msg_to_zone", false),
                            MessageFactionId = reader.GetUInt32("msg_to_faction_id", 0),
                            IsMessageToWorld = reader.GetBoolean("is_msg_to_world", false),
                            UseUiMessage = reader.GetBoolean("use_ui_msg", false),
                            IconKey = reader.GetString("icon_key", string.Empty),
                            Color = reader.GetString("color", string.Empty),
                            TitleMessage = reader.GetString("title_msg", string.Empty),
                            TitleColor = reader.GetString("title_color", string.Empty),
                            OverHeadMarkGap = reader.GetInt32("over_head_mark_gap", 0)
                        };
            ...
            using (var command = connection.CreateCommand())
            {
                ...
                using (var reader = new SQLiteWrapperReader(sqliteDataReader))
                {
                    while (reader.Read())
                    {
                        ...
                        template.Model = reader.GetString("model", string.Empty);
                        template.ShowName = reader.GetBoolean("show_name", false);
                        template.ShowMinimap = reader.GetBoolean("show_minimap", false);
                        template.MarkModel = reader.GetString("mark_model", string.Empty);
                        template.LoadModelFromWorld = reader.GetBoolean("load_model_from_world", false);
                        template.Translate = reader.GetBoolean("translate", true);
                        template.SpawnFxGroupId = reader.GetUInt32("spawn_fx_group_id", 0);
                        template.SystemDoodad = reader.GetBoolean("system_doodad", false);
                        template.DeleteWhenCreatorMissing = reader.GetBoolean("delete_when_not_exist_creator", false);
                        template.PlaceAreaKindId = reader.GetUInt32("place_area_kind_id", 0);
                        template.ResetData = reader.GetBoolean("reset_data", false);
                        template.PassUpdateDistance = reader.GetBoolean("pass_update_dist", true);
                        template.PassThroughOuterSide = reader.GetBoolean("pass_through_outerside", true);
                        template.PassThroughInnerSide = reader.GetBoolean("pass_through_innerside", true);
                        template.ViewDistanceRatio = reader.GetInt32("view_dist_ratio", 100);
                        template.ClientDoodad = reader.GetBoolean("client_doodad", false);
                        template.OrUnitRequirements = reader.GetBoolean("or_unit_reqs", false);
                        template.CustomDualMaterialId = reader.GetUInt32("custom_dual_material_id", 0);
                        template.SimHeight = reader.GetInt32("sim_height", 0);
    ...
    /// <summary>
    /// Registers non-destructive placeholders only for target 10.8 actual_func
    /// records that were loaded from base.sqlite3 but have no dedicated C#
    /// implementation. This never consults the old compact database.
    /// </summary>
    private void InstallTargetFunctionFallbacks()
    {
        var normalFallbacks = 0;
        foreach (var func in _funcsById.Values)
        {
            if (!_funcTemplates.TryGetValue(func.FuncType, out var templates))
            {
                templates = new Dictionary<uint, DoodadFuncTemplate>();
                _funcTemplates.Add(func.FuncType, templates);
            }

            if (templates.ContainsKey(func.FuncId))
                continue;

            templates.Add(func.FuncId, new GenericDoodadFuncTemplate
            {
                Id = func.FuncId,
                ActualFuncType = func.FuncType
            });
            normalFallbacks++;
        }

        var phaseFallbacks = 0;
        foreach (var group in _phaseFuncs.Values)
        {
            foreach (var func in group)
            {
                if (!_phaseFuncTemplates.TryGetValue(func.FuncType, out var templates))
                {
                    templates = new Dictionary<uint, DoodadPhaseFuncTemplate>();
                    _phaseFuncTemplates.Add(func.FuncType, templates);
                }

                if (templates.ContainsKey(func.FuncId))
                    continue;

                templates.Add(func.FuncId, new GenericDoodadPhaseFuncTemplate
                {
                    Id = func.FuncId,
                    ActualFuncType = func.FuncType
                });
        ...
        Logger.Warn(
            "Target 10.8 doodad compatibility fallbacks installed: normal={0}, phase={1}. " +
            "All records came from Data/base.sqlite3; unsupported behavior remains non-destructive.",
            normalFallbacks,
            phaseFallbacks);
    }
    ...
    private void CreateTemplateCaches()
    {
        ...
        foreach (var template in _templates.Values)
        {
            ...
            {
                var phaseFuncs = Instance.GetPhaseFunc(funcGroup.Id);
                foreach (var phaseFunc in phaseFuncs)
                {
                    var thisFuncTemplate = Instance.GetPhaseFuncTemplate(phaseFunc.FuncId, phaseFunc.FuncType);
        ...
        bool skipPhaseInitialization = false)
    {
        ...
        switch (ownerObject)
        {
            case Character character:
                ...
                doodad.CreatorId = character.Id;
                doodad.OriginatorId = character.Id;
                doodad.FactionId = character.Faction?.Id ?? template.FactionId;
    ...
    /// <summary>
    /// Builds the target 10.8 world-interaction list for the current doodad
    /// function group. Core func_skill_id values come directly from
    /// Data/base.sqlite3. Older detail tables are not used as a fallback.
    /// </summary>
    public uint[] GetInteractionSkills(uint funcGroupId, int maxCount = 10)
    {
        if (maxCount <= 0 || !_funcsByGroups.TryGetValue(funcGroupId, out var funcs))
            return Array.Empty<uint>();

        var result = new List<uint>(Math.Min(maxCount, 10));
        foreach (var func in funcs)
        {
            var skillId = func.SkillId;
            if (skillId == 0)
            {
                var template = GetFuncTemplate(func.FuncId, func.FuncType);
                if (template is DoodadFuncUse use && use.SkillId != 0)
                    skillId = use.SkillId;
                else if (template is DoodadFuncFakeUse fakeUse && fakeUse.FakeSkillId != 0)
                    skillId = fakeUse.FakeSkillId;
            }

            // Zero is meaningful for client-side actions such as mailbox,
            // bank, store and several navigation functions.
            if (!result.Contains(skillId))
                result.Add(skillId);

            if (result.Count >= Math.Min(maxCount, 10))
                break;
        }
