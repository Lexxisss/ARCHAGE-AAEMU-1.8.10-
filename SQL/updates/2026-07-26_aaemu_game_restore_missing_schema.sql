-- Idempotent recovery of the base aaemu_game schema for partially initialized databases.
-- Generated mechanically from SQL/aaemu_game.sql: no DROP statements; existing rows are preserved.
